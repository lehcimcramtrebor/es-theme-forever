...
Place here all of yours 16/9 background system or images tiles named by theme:
	...
	to display tileable backgrounds:
		...
		- "tile.png" (or ".jpg") for general tileable background.

		- "tile-megadrive.png" (or ".jpg") for themed tileable backgrounds.
...
-------------------------------------------------------------------------------------------
	...
	YOU CAN PUT: 
		...
		- "tile.jpg" for general and "background-megadrive.png" for themed or inverse, no problem with differents images formats.
